...
bool IsTargetNode (RouteModel::Node * target_node,  RouteModel::Node * current_node) {

    return (target_node->x == current_node->x) && (target_node->y == current_node->y);
}
...
void RoutePlanner::AStarSearch() {
    ...
    *current_node = *start_node;
    ...
    while (!open_list.empty()) {
      ...
      if (IsTargetNode(end_node, current_node)) {
